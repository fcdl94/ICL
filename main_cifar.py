...
parser = argparse.ArgumentParser(description='Incremental class learning on CIFAR dataset.')
...
depth = args.depth  # Set the depth of the architecture: n = 5 -> 32 layers (See He et al. paper)
